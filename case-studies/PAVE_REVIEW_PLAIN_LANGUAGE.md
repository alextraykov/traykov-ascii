...
note: Scroll sideways to compare the builder lineage from Flint through Blinq, Pave v1 and Pave's new navigation.
columns: 4
/case-studies/pave-evidence/scaffold-jan-2026-blinq.webp | 01 / Flint to Blinq | The earliest retained builder shell already carries the Blinq name. It preserves the chat-and-preview structure at the Flint-to-Blinq handoff; a Flint-labeled capture is not in the current archive.
/case-studies/pave-evidence/blinq-builder-workspace.png | 02 / Blinq builder | Blinq expanded that shell into one workspace for app selection, conversation, build activity and preview.
/case-studies/pave-evidence/pave-v1-builder.png | 03 / Pave v1 builder | The first Pave builder kept the global rail and split chat/preview model while the product system changed underneath it.
/case-studies/pave-evidence/direct-edit-sequence.webp | 04 / Pave new navigation | The Build/Manage header and app-level context reorganized the same builder around the product Pave had become.
```
